...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ["en"] = new()
        {
            ...
            ["ComingM32"] = "This section has no separate settings.",
            ...
            ["LookInfo"] = "Dark and light themes plus .zbs skins (including classic Winamp) — all built in. Accent — ZBS Voltage #00E676.",
            ["UpdatesInfo"] = "Zero-Bloat Sound — open-source build. Check the latest release on GitHub.",
        ...
        ["ru"] = new()
        {
            ...
            ["ComingM32"] = "В этом разделе нет отдельных настроек.",
            ...
            ["LookInfo"] = "Тёмная и светлая темы, плюс скины .zbs (включая классические Winamp) — всё встроено. Акцент — ZBS Voltage #00E676.",
            ["UpdatesInfo"] = "Zero-Bloat Sound — сборка с открытым кодом. Проверь последний релиз на GitHub.",
